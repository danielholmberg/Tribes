            ...
            return StreamBuilder<List<UserData>>(
              ...
              builder: (context, snapshot) {
                if(snapshot.hasData) {
                  ...
                  tribesList.forEach((tribe) => friendsList.addAll(tribe.members.where((memberID) => (!friendsList.contains(memberID) && currentUser.id != memberID))));
                  
                  friendsList.forEach((friendID) => friendsDataList.add(usersList.singleWhere((user) => user.id == friendID)));
                  ...
                  return Stack(
                    ...
                    children: <Widget>[
                      ...
                      Opacity(opacity: _isMapLoading ? 1.0 : 0.0, child: Center(child: Loading()))   
                    ],
                  );

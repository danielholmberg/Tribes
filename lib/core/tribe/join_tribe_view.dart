...
class JoinTribeView extends StatefulWidget {
  @override
  _JoinTribeViewState createState() => _JoinTribeViewState();
}

class _JoinTribeViewState extends State<JoinTribeView> {
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        loadingDialog ? Loading() : Container(
                          child: Form(
                                  ...
                                  child: TextFormField(
                                    ...
                                    onChanged: (val) {
                                      if(activeTribe.password == '$val$two$three$four$five$six') {
                                        ...
                                        DatabaseService().addUserToTribe(currentUser.id, activeTribe.id);
            ...
            children: <Widget>[
              Positioned.fill(
                child: StreamBuilder<List<Tribe>>(
                  stream: DatabaseService().notYetJoinedTribes(currentUser.id),

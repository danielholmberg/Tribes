        ...
        child: Column(
          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: model.isAnotherUser
                      ? null
                      : () =>
                          (model.isBusy ? null : model.chooseNewProfilePic()),
                  child: Stack(
                ...
                Column(
                  ...
                  children: <Widget>[
                    Text(
                      NumberFormat.compact().format(model.isAnotherUser
                          ? model.profileUser.createdPosts.length
                          : model.currentUser.createdPosts.length),
                      style: TextStyle(
                        color: Colors.white,
                  ...
                  children: <Widget>[
                    Text(
                      NumberFormat.compact().format(
                        model.isAnotherUser
                            ? model.profileUser.likedPosts.length
                            : model.currentUser.likedPosts.length,
                      ),
                      style: TextStyle(
                        color: Colors.white,
                        fontFamily: 'TribesRounded',
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Visibility(
                visible: model.isAnotherUser
                    ? model.profileUser.info.isNotEmpty
                    : model.currentUser.info.isNotEmpty,
                child: Divider(),
              ),
              Visibility(
                visible: model.isAnotherUser
                ...
                child: Container(
                  ...
                  child: AutoSizeText(
                    model.isAnotherUser
                        ? model.profileUser.info
                        : model.currentUser.info,
                    maxLines: 2,
                    overflow: TextOverflow.fade,
                    ...
                    Container(
                      ...
                      child: TabBar(
                        ...
                        unselectedLabelColor:
                            Constants.buttonIconColor.withOpacity(0.7),
                        tabs: model.tabs,
                      ),
                    ),
                    Expanded(
